...
export declare type RequestHandler<_Data> = (
	this: FetchContext,
	params: FetchParams,
	session?: FetchSession
) => Promise<RequestPayload<_Data>>;
export declare function executeQuery<_Data extends GraphQLObject, _Input>(
	artifact: QueryArtifact | MutationArtifact,
	variables: _Input,
	sessionStore: Readable<any>,
	cached: boolean
): Promise<RequestPayload>;
export declare function convertKitPayload(
	context: RequestContext,
	loader: (ctx: FetchContext) => Promise<KitLoadResponse>,
	page: FetchContext['page'],
	session: FetchContext['session']
): Promise<Record<string, any>>;
export declare function fetchQuery<_Data extends GraphQLObject>({
	context,
	artifact,
	variables,
	session,
...
export declare class RequestContext {
	...
	graphqlErrors(payload: { errors?: GraphQLError[] }): void;
	onLoadHook({
		mode,
		onLoadFunction
	}: {
