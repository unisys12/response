...
func (mq *MetadataQuery) ForUpdate(opts ...sql.LockOption) *MetadataQuery {
...
func (mq *MetadataQuery) ForShare(opts ...sql.LockOption) *MetadataQuery {
	if mq.driver.Dialect() == dialect.Postgres {
		mq.Unique(false)
	}
	mq.modifiers = append(mq.modifiers, func(s *sql.Selector) {
...
func (mq *MetadataQuery) Modify(modifiers ...func(s *sql.Selector)) *MetadataSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (ms *MetadataSelect) Modify(modifiers ...func(s *sql.Selector)) *MetadataSelect {
