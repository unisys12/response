...
const (
	// Label holds the string label denoting the deathmanner type in the database.
	Label = "death_manner"
	...
	// Table holds the table name of the deathmanner in the database.
	Table = "death_manners"
	// MetadataTable is the table that holds the metadata relation/edge.
	MetadataTable = "death_manners"
	// MetadataInverseTable is the table name for the Metadata entity.
	// It exists in this package in order to avoid circular dependency with the "metadata" package.
	MetadataInverseTable = "metadata"
	// MetadataColumn is the table column denoting the metadata relation/edge.
	MetadataColumn = "death_manner_metadata"
	...
	DeathCertificatesColumn = "death_manner_death_certificates"
)

// Columns holds all SQL columns for deathmanner fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "death_manners"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"death_manner_metadata",
}
