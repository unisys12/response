...
const (
	// Label holds the string label denoting the vehicleclass type in the database.
	Label = "vehicle_class"
	...
	// Table holds the table name of the vehicleclass in the database.
	Table = "vehicle_classes"
	// MetadataTable is the table that holds the metadata relation/edge.
	MetadataTable = "vehicle_classes"
	// MetadataInverseTable is the table name for the Metadata entity.
	// It exists in this package in order to avoid circular dependency with the "metadata" package.
	MetadataInverseTable = "metadata"
	// MetadataColumn is the table column denoting the metadata relation/edge.
	MetadataColumn = "vehicle_class_metadata"
	...
	VehiclesColumn = "vehicle_class_vehicles"
)

// Columns holds all SQL columns for vehicleclass fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "vehicle_classes"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"vehicle_class_metadata",
}
