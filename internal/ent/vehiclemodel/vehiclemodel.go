...
const (
	// Label holds the string label denoting the vehiclemodel type in the database.
	Label = "vehicle_model"
	...
	// Table holds the table name of the vehiclemodel in the database.
	Table = "vehicle_models"
	// MetadataTable is the table that holds the metadata relation/edge.
	MetadataTable = "vehicle_models"
	// MetadataInverseTable is the table name for the Metadata entity.
	// It exists in this package in order to avoid circular dependency with the "metadata" package.
	MetadataInverseTable = "metadata"
	// MetadataColumn is the table column denoting the metadata relation/edge.
	MetadataColumn = "vehicle_model_metadata"
	...
	VehiclesColumn = "vehicle_model_vehicles"
)

// Columns holds all SQL columns for vehiclemodel fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "vehicle_models"
