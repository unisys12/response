...
const (
	// Label holds the string label denoting the deathplace type in the database.
	Label = "death_place"
	...
	// Table holds the table name of the deathplace in the database.
	Table = "death_places"
	// MetadataTable is the table that holds the metadata relation/edge.
	MetadataTable = "death_places"
	// MetadataInverseTable is the table name for the Metadata entity.
	// It exists in this package in order to avoid circular dependency with the "metadata" package.
	MetadataInverseTable = "metadata"
	// MetadataColumn is the table column denoting the metadata relation/edge.
	MetadataColumn = "death_place_metadata"
	...
	DeathCertificatesColumn = "death_place_death_certificates"
)

// Columns holds all SQL columns for deathplace fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "death_places"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"death_place_metadata",
}
